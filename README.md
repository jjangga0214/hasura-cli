...
Currently there are 2 npm tags (npm tags are different from versions), `latest` and `beta`. `latest` tag refers to Hasura's latest stable version(e.g. v1.2.2 as of writing), while `beta`, beta version(e.g. v1.3.0-beta.2 as of writing).
